...
class DQN(object):
    def __init__(self, n_states, n_actions, learning_rate=0.005, epsilon=1,
                 epsilon_min=0.001, epsilon_decay_step=300, gamma=0.95, batch_size=50):
    ...
    def learn(self):
        ...
        q_next = self.session.run(self.target_net, feed_dict={self.s_: bs_})
